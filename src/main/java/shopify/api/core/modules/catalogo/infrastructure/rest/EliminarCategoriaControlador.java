...
import shopify.api.core.modules.catalogo.application.casouso.EliminarCategoriaCasoUso;
...
public class EliminarCategoriaControlador {

    private final EliminarCategoriaCasoUso casoUso;

    @Operation(summary = "Eliminar lógicamente una categoría (Soft-delete)", security = @SecurityRequirement(name = "BearerAuth"))
    @DeleteMapping("/{id}")
